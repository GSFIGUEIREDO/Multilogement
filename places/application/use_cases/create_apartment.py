...
from src.climaparc.places.application.commands import CreateApartmentCommand
...
class CreateApartmentUseCase:
    ...
    def __call__(self, command: CreateApartmentCommand) -> dict:
        ...
        if find_item_index(apartments, apartment["id"]) >= 0:
            raise ApplicationError("Appartement existe deja.", HTTPStatus.CONFLICT)
